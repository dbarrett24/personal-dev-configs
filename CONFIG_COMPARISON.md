...
|------------|------------------|-------------------|------------------|
| **TypeScript** | `tsconfig/base.json` | `wavebid-a2o-ui/tsconfig.json` | ✅ `typescript-config/base.json` |
| **Prettier** | `prettier-config-hammer-ui/.prettierrc.mjs` | `wavebid-a2o-ui/.prettierrc.mjs` | ✅ `prettier-config/index.mjs` |
| **ESLint (Base)** | `eslint-config-hammer-ui/index.js` | `wavebid-a2o-ui/.eslintrc.js` | ✅ `eslint-config/index.js` |
| **Jest (Base)** | `testing-setup/src/jest.config.ts` | `wavebid-a2o-ui/jest.config.ts` | ✅ `jest-config/index.ts` |
| **Testing Utils** | `testing-setup/src/render.tsx` | N/A | ✅ `testing-utils/src/render.tsx` |
...
| Source maps | ✅ | ✅ | ✅ | Inline in libs, separate in apps |
| Path aliases | ✅ (`src/*`) | ✅ (`@/*`) | ✅ (`@/*`, `src/*`) | Both patterns supported |
| Declaration files | `false` (generated by tsup) | N/A | ✅ | We generate in build |
...
| Tab width | `4` | `4` | `4` | ✅ |
| Semicolons | ✅ | ✅ | ✅ | ✅ |
| Trailing comma | `'es5'` | `'es5'` | `'es5'` | ✅ |
| Print width | `120` | `120` | `120` | ✅ |
| Arrow parens | `'always'` | N/A | `'always'` | ⚠️ |
| Single attribute per line | ✅ | ✅ | ✅ | ✅ |
| Tailwind plugin | ✅ | ✅ | ✅ | ✅ |
| Tailwind functions | `['cn']` | `['cn']` | `['cn']` | ✅ |

**Perfect Match!** ✅ Our Prettier config exactly matches the work configs.
...
| `prettier` (disable conflicts) | ✅ | ✅ | ✅ | ✅ |
| **Key Plugins** |
| `testing-library` | ✅ | ✅ | ✅ | ✅ |
| `jest-formatting` | ✅ | ❌ | ✅ | ⚠️ |
| `sort-keys` | ✅ | ❌ | ✅ | ⚠️ |
| `sort-destructure-keys` | ✅ | ❌ | ✅ | ⚠️ |
| `sort-imports-es6-autofix` | ✅ | ❌ | ✅ | ⚠️ |
| **Custom Rules** |
| `no-console: 2` | ✅ | ✅ | ✅ | ✅ |
| `@typescript-eslint/no-explicit-any: 0` | ✅ | ❌ (strict) | ✅ base, ❌ lib | ⚠️ |
| `react/jsx-sort-props` | ✅ | ❌ | ✅ | ⚠️ |
| `curly: [2, 'all']` | ✅ | ✅ | ✅ | ✅ |
| `max-len: 120` | ✅ | ✅ | ✅ | ✅ |
| **Overrides** |
| Testing Library rules for `*.spec.*` | ✅ | ✅ | ✅ | ✅ |
...
| Coverage in CI only | ✅ | ✅ | ✅ | ✅ |
| Coverage directory | ✅ | ✅ | ✅ | ✅ |
| Coverage reporters | `['lcov', 'clover', 'json', 'text']` | `['lcov', 'clover', 'json', 'text']` | ✅ | ✅ |
| **Coverage Thresholds** |
| Global threshold | None | 85-91% | 90% (apps), 95% (libs) | ⚠️ |
| **Transform** |
| Transformer | `@swc/jest` | `babel-jest` | `@swc/jest` | ⚠️ |
| **Reporters** |
| `jest-junit` | ✅ | ✅ | ✅ | ✅ |
| **Module Mapping** |
| `src/*` alias | ✅ | N/A | ✅ | ✅ |
...
| CSS mocks | ✅ | ✅ | ✅ | ✅ |
| Image/SVG mocks | N/A | ✅ | ✅ | ✅ |
| `next/image` mock | N/A | ✅ (V3 tests) | ❌ | ⚠️ |
| **Setup Files** |
| `setupFilesAfterEnv` | ✅ | ✅ | ✅ | ✅ |
| `globalSetup` | N/A | ✅ | ❌ | ⚠️ |
...
| **Jotai Support** |
| Jotai store management | ✅ (deprecated) | ✅ (direct store) | ✅ |
...
## 🎯 What's in Personal Configs But NOT in Work Repos
...
- ✅ All core configs (TypeScript, ESLint, Prettier, Jest) match
- ✅ Testing utilities are MORE comprehensive
- ✅ Stricter library development rules
- ⚠️ Missing `tsup-config` (critical for publishing)
- ⚠️ Missing some Next.js-specific test utilities
