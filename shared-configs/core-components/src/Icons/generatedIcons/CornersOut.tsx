...
export const CornersOut = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
    return <IconBase ref={ref} displayName="CornersOut" {...props} weights={weights} />;
});
