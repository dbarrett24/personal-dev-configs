...
export const PencilLine = React.forwardRef<SVGSVGElement, IconProps>((props, ref) => {
    return <IconBase ref={ref} displayName="PencilLine" {...props} weights={weights} />;
});
